...
class Solution {
private:
    // Usamos static para que el mapa se inicialice una sola vez entre llamadas
    static inline std::unordered_map<int, int> fibMap = {
        {1, 1}, {2, 2}, {3, 3}, {4, 5}, {5, 8}, {6, 13}, {7, 21}, {8, 34},
        {9, 55}, {10, 89}, {11, 144}, {12, 233}, {13, 377}, {14, 610},
        {15, 987}, {16, 1597}, {17, 2584}, {18, 4181}, {19, 6765}, {20, 10946},
...
public:
    int climbStairs(int n) {
        ...
        return 0; // O la lógica para calcularlo si n > 45
    }
};